...
export function generateRandomHealthData(): YearlyHealthData {
  ...
  for (let year = 1; year <= 10; year++) {
    data[`year_${year}`] = {
      ...
      bodyTemperature: Number(
        (Math.random() * (37.5 - 36.0) + 36.0).toFixed(2)
      ), // 36.0-37.5°C
